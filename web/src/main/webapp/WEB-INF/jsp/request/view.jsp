...
<c:if test="${not empty request}">
        ...
        <textarea class='form-control' id='detailDesc' 
                    name='detailDesc'>${request.detailDesc}</textarea>
        </div>
        </div>
        ...
        name='genre' value="${request.genre}">
        </div>
        </div>
        ...
        name='entryDate' value="${request.entryDate}">
        </div>
        </div>
        ...
        <div class='col-sm-10'>
        <input class='form-control' id='location' type='text' name='location' value="${request.location}">
        </div>
        </div>
        ...
        <div class='col-sm-10'>
        <input class='form-control' id='specialDesc' type='text' name='specialDesc' value="${request.specialDesc}">
        </div>
        </div>
        ...
        <a href='delete?no=${request.no}' class='btn btn-primary btn-sm'>게시물 삭제</a>
        </div>
        </div>
        </form>
</c:if>
